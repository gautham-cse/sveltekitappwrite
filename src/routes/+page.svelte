        ...
        <div class="a-2--x">
            <div>
                ...
                <div class="a-google__auth" style="margin-bottom: 20px">
                    <button type="button" id="app-submit--signInWithGoogleAuth" on:click={__handleMagicURL}>Login with Magic Link</button>
                ...
                <form method="post" on:submit|preventDefault={airbase_login}>
